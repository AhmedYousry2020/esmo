...
@section('content')
	...
	<div class="bg-0 p-t-100 p-b-50">
        <div class="container">
            ...
            <img src="{{asset('assets/images/services-01.jpg')}}" alt="IMG">
            </a>
            ...
            <div class="bg-10 h-full">
            <a href="services-detail-01.html" class="hov-img0 of-hidden bg-0">
            <img src="{{asset('assets/images/services-02.jpg')}}" alt="IMG">
            </a>
            <div class="p-rl-30 p-t-26 p-b-20">
            <h4 class="p-b-9">
            <a href="services-detail-01.html" class="t1-m-1 cl-0 hov-link2 trans-02">
            ...
            <div class="bg-10 h-full">
            <a href="services-detail-01.html" class="hov-img0 of-hidden bg-0">
            <img src="{{asset('assets/images/services-03.jpg')}}" alt="IMG">
            </a>
            <div class="p-rl-30 p-t-26 p-b-20">
            <h4 class="p-b-9">
            <a href="services-detail-01.html" class="t1-m-1 cl-0 hov-link2 trans-02">
