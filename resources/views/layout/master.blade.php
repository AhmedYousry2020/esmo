...
<html lang="en">
<head>
	<title>                                شركة انظمة الكفاءة للتشغيل والصيانة
	</title>
	<meta charset="UTF-8">
...
<body class="animsition">
	...
	<header>
		<!-- Header desktop -->
		<nav class="container-header-desktop" style="direction: rtl">
			<div class="top-bar">
	...
	<footer>
		<div class="parallax100 kit-overlay1 p-t-35 p-b-10" style="background-image: url(images/bg-03.jpg);">
			<div class="container">
				<div class="row footer-content justify-content-center" style="direction: rtl">
					<div class="col-sm-8 col-md-4 col-lg-4 p-b-20">
						<div class="size-h-1 flex-s-e p-b-6 m-b-18">
							<a href="#">
								<img class="max-s-full" src="{{asset('assets/images/icons/2.png')}}" alt="IMG">
							</a>
						</div>
...
507331118 (966+)
					...
					<div class="col-sm-8 col-md-4 col-lg-2 p-b-20">
						<div class="size-h-1 flex-s-e m-b-18">
							<h4 class="t1-m-3 text-uppercase cl-0">
								الشركه
							</h4>
...
النتجعات السياحية									</a>
    ...
    <a id="back-to-top" href="https://wa.me/+966507331118" class="btn btn-default btn-filled" style="display: inline">
...
<!--===============================================================================================-->
	<script src="{{asset('assets/vendor/waypoint/jquery.waypoints.min.js')}}"></script>
<!--===============================================================================================-->
	<script src="{{asset('assets/vendor/countterup/jquery.counterup.min.js')}}"></script>
<!--===============================================================================================-->
